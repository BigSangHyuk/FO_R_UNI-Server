...
class ScrappedServiceTest {
    ...
    void beforeEach() {
        ...
        postRepository.save(new Post(1L, false, "test1", "test1", "test1", 0, 0, true, LocalDate.now(), LocalDate.now()));
        postRepository.save(new Post(2L, false, "test2", "test2", "test2", 0, 0, true, LocalDate.now(), LocalDate.now()));
